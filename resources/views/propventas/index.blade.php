            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box-header">
                        <h3 class="box-title">Crear, editar o eliminar los bienes negociables</h3>

                        <div class="box-tools">
                            <a class="btn bg-dark btn-flat" href="{{ route('propventas.create') }}">
            ...
            <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        ...
                        <small>Administrar los tipos de Bienes que se tienen para la compra o para la venta por parte de los clientes</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> SISGestión</a></li>
                        <li>Parámetros</li>
                        <li class="active">Propiedades negociables</li>
                    </ol>
                </section>
