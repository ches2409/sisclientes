<section class="content">
    <div class="box box-warning">
        ...
        <form method="POST" action="{{ route('referidos.update', $referido->id) }}" role="form">
            @method('PUT')
            @csrf
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" class="form-control" placeholder=" ..." value="{{ $referido->nombre }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telefono" class="form-control" placeholder=" ..." value="{{ $referido->telefono }}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="refiere" class="form-control" placeholder=" ..." value="{{ $referido->refiere }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="parentesco" class="form-control" placeholder=" ..." value="{{ $referido->parentesco }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="notas" class="form-control" rows="3" placeholder=" ..." >{{ $referido->notas }}</textarea>
                </div>
