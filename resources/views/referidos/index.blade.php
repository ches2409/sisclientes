            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box-header">
                        <h3 class="box-title">Crear, editar o eliminar Referidos</h3>

                        <div class="box-tools">
                            <a class="btn bg-dark btn-flat" href="{{ route('referidos.create') }}">
        ...
        @section('contentWrapper')
            ...
            <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Referidos
                        <small>Administrar los Referidos de la empresa</small>
                    </h1>
                    <ol class="breadcrumb">
