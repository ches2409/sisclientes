            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box-header">
                        <h3 class="box-title">Crear, editar o eliminar los estados de la propiedad</h3>
                        <div class="box-tools">
                            <a class="btn bg-dark btn-flat" href="{{ route('propiedadestados.create') }}">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <div class="box box-warning">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    @foreach ($propiedadestados as $propiedadestado)
                                        <tr>
                                            <td>{{ $propiedadestado->nombre }}</td>
                                            <td>{{ $propiedadestado->descripcion }}</td>
                                            <td>
                                                <a class="btn bg-dark btn-flat" href="{{ route('propiedadestados.show', $propiedadestado->id) }}">
                                                    <span class="glyphicon glyphicon-pencil"></span>
                                                    Editar
                                                </a>

                                                <form style="display:inline" method="POST" action="{{ route ('propiedadestados.destroy', $propiedadestado->id) }}">
                                                    @csrf
                                                    @method('DELETE')
