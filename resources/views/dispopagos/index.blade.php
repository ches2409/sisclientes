            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box-header">
                        <h3 class="box-title">Crear, editar o eliminar Disponibilidad de pagos</h3>

                        <div class="box-tools">
                            <a class="btn bg-dark btn-flat" href="{{ route('dispopagos.create') }}">
